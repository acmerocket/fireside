...
public class DefaultStoryFileHeader implements StoryFileHeader {
   ...
   * {@inheritDoc}
   */
  public int getVersion() { return memory.readUnsignedByte(0x00); }
  
  /**
   * {@inheritDoc}
   */
  public int getRelease() { return memory.readUnsignedShort(0x02); }
  
  /**
   * {@inheritDoc}
   */
  public int getHighMemAddress() { return memory.readUnsignedShort(0x04); }
  
  /**
   * {@inheritDoc}
   */
  public int getProgramStart() { return memory.readUnsignedShort(0x06); }
   ...
   * {@inheritDoc}
   */
  public int getGlobalsAddress() { return memory.readUnsignedShort(0x0c); }
  
  /**
   * {@inheritDoc}
   */
  public int getStaticsAddress() { return memory.readUnsignedShort(0x0e); }
   ...
   * {@inheritDoc}
   */
  public int getChecksum() { return memory.readUnsignedShort(0x1c); }
